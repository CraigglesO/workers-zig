...
esbuild
  .buildSync({
    ...
    bundle: true,
    minify: false,
    outfile: './dist/tmp_worker_wasi.mjs',
...
esbuild
  ...
  .then(() => {
    // cleanup tmp files
    unlinkSync('./dist/tmp_worker_wasi.mjs')
...
function stepFour () {
  const file = readFileSync('./dist/workerWASI.mjs', 'utf8')
  ...
  writeFileSync('./dist/workerWASI.mjs', code)
}